...
!function (t, i) {
  ...
  function r(t) {
    return !1 !== n && ("standard" === n ? "transitionEnd" === t ? "transitionend" : t : n + t.charAt(0).toUpperCase() + t.substr(1));
  }
  ...
  function I(t, i, e, s, o, n, r) {
    var h = t - i,
        ...
        m = d ? 4 : 15,
        f = t + a / l * (h < 0 ? -1 : 1);
    return d && c && (f = Math.round(f / c) * c), f < s ? (f = n ? Math.max(s - n / 4, s - n / m * a) : s, u = p) : o < f && (f = n ? Math.min(o + n / 4, o + n / m * a) : o, u = p), {
  ...
  B.prototype.handleEvent = function (t) {
  ...
  }, B.prototype.fade = function (t, i) {
    var e = this;

    if (!i || this.visible) {
      var s = t ? 250 : 500;
      t = t ? "1" : "0", this.wrapperStyle[T.transitionDuration] = s + "ms", clearTimeout(this.fadeTimeout), this.fadeTimeout = setTimeout(function () {
    ...
    this.indicatorStyle[T.transitionTimingFunction] = t;
  }, B.prototype.destroy = function () {
    this._removeDOMEvents(), this.wrapper.parentNode.removeChild(this.wrapper);
  }, B.prototype._start = function (t) {
  ...
  }, B.prototype._shouldShow = function () {
  ...
  function ot(t, i) {
    this.wrapper = "string" == typeof t ? document.querySelector(t) : t, this.wrapper || F("Can not resolve the wrapper DOM."), this.scroller = this.wrapper.children[0], this.scroller || F("The wrapper need at least one child element to be scroller."), this.scrollerStyle = this.scroller.style, this._init(t, i);
  }
  ...
  return st.prototype.onScroll = function () {
    ...
    this.onScroll();
  }, st.prototype.fill = function (t, i) {
  ...
  }, st.prototype.maybeRequestContent = function () {
    var s = this;
    ...
    for (var i = 0; i < t.length; i++) {
      this.items.length <= this.loadedItems && this._addItem(), this.items[this.loadedItems++].data = t[i];
    }
  ...
  }, st.prototype.resetMore = function () {
    this.hasMore = !0;
    ...
    return i;
  }, st.prototype._cleanupUnusedNodes = function (t) {
    for (; t.length;) {
      this.scrollerEl.removeChild(t.pop());
    }
  }, st.prototype._cacheNodeSize = function () {
  ...
  }, st.prototype._fixScrollPosition = function () {
    for (var t = this.anchorScrollTop = 0; t < this.anchorItem.index; t++) {
    ...
    for (var i = this.anchorScrollTop - this.anchorItem.offset, e = this.anchorItem.index; e > this.firstAttachedItem;) {
      i -= this.items[e - 1].height || this.tombstoneHeight, e--;
    }
  ...
  }, st.prototype._getTombStone = function () {
  ...
  }, st.prototype._addItem = function () {
    this.items.push({
      data: null,
      node: null,
      height: 0,
  ...
  }, st.prototype._calculateAnchoredItem = function (t, i) {
    if (0 === i) return t;
    var e = t.index,
        s = 0;

    if ((i += t.offset) < 0) {
      for (; i < 0 && 0 < e && this.items[e - 1].height;) {
        i += this.items[e - 1].height, e--;
      }

      s = Math.max(-e, Math.ceil(Math.min(i, 0) / this.tombstoneHeight));
    } else {
      for (; 0 < i && e < this.items.length && this.items[e].height && this.items[e].height < i;) {
        i -= this.items[e].height, e++;
      }
  ...
  }, (q = ot).prototype._init = function (t, i) {
  ...
  }, q.prototype._initExtFeatures = function () {
  ...
  }, q.prototype._watchTransition = function () {
    if ("function" == typeof Object.defineProperty) {
      ...
      Object.defineProperty(this, t, {
        ...
        set: function set(t) {
          ...
          for (var i = o.scroller.children.length ? o.scroller.children : [o.scroller], e = n && !o.pulling ? "none" : "auto", s = 0; s < i.length; s++) {
            i[s].style.pointerEvents = e;
          }
        }
      });
    }
  }, q.prototype._handleAutoBlur = function () {
    this.on("scrollStart", function () {
      var t = document.activeElement;
      !t || "INPUT" !== t.tagName && "TEXTAREA" !== t.tagName || t.blur();
    });
  }, q.prototype._initDOMObserver = function () {
    var n = this;
  ...
  }, q.prototype._shouldNotRefresh = function () {
  ...
  }, q.prototype._checkDOMUpdate = function () {
    ...
    this.enabled = !1;
  }, (V = ot).prototype._start = function (t) {
    var i = _[t.type];
    ...
    if (this.enabled && !this.destroyed && _[t.type] === this.initiated) {
      ...
      var i = Math.round(this.x),
          ...
          s = i - this.absStartX,
          o = e - this.absStartY;
      if (this.directionX = 0 < s ? C : s < 0 ? O : 0, this.directionY = 0 < o ? A : o < 0 ? W : 0, !this.options.pullDownRefresh || !this._checkPullDown()) if (this._checkClick(t)) this.trigger("scrollCancel");else if (!this.resetPosition(this.options.bounceTime, D.bounce)) {
        ...
        if (this._events.flick && n < this.options.flickLimitTime && r < this.options.flickLimitDistance && h < this.options.flickLimitDistance) this.trigger("flick");else {
          ...
          if (this.options.momentum && n < this.options.momentumLimitTime && (h > this.options.momentumLimitDistance || r > this.options.momentumLimitDistance)) {
            ...
            var m = this.directionX === C && p || this.directionX === O && d ? this.wrapperWidth : 0,
                ...
                g = this.hasHorizontalScroll ? I(this.x, this.startX, n, this.maxScrollX, this.minScrollX, m, this.options) : {
              destination: i,
              duration: 0
            },
                v = this.hasVerticalScroll ? I(this.y, this.startY, n, this.maxScrollY, this.minScrollY, f, this.options) : {
              destination: e,
              duration: 0
            };
    ...
    var i,
        e,
        s,
        o = this.stopFromTransition && !this.pulling;
    ...
    var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : 0;
    if (this.scrollerStyle[T.transitionDuration] = t + "ms", this.options.wheel) for (var i = 0; i < this.items.length; i++) {
    ...
    if (this.scrollerStyle[T.transitionTimingFunction] = t, this.options.wheel) for (var i = 0; i < this.items.length; i++) {
      this.items[i].style[T.transitionTimingFunction] = t;
    }
    if (this.indicators) for (var e = 0; e < this.indicators.length; e++) {
      this.indicators[e].transitionTimingFunction(t);
    }
  }, V.prototype._transitionEnd = function (t) {
    t.target === this.scroller && this.isInTransition && (this._transitionTime(), (!this.pulling || this.movingDirectionY === W) && !this.resetPosition(this.options.bounceTime, D.bounce) && (this.isInTransition = !1, this.options.probeType !== R && this.trigger("scrollEnd", {
      x: this.x,
      y: this.y
    })));
  }, V.prototype._translate = function (t, i, e) {
    if (U(!p(t) && !p(i), "Translate x or y is null or undefined."), p(e) && (e = this.scale), this.options.useTransform ? this.scrollerStyle[T.transform] = "translate(" + t + "px," + i + "px) scale(" + e + ")" + this.translateZ : (t = Math.round(t), i = Math.round(i), this.scrollerStyle.left = t + "px", this.scrollerStyle.top = i + "px"), this.options.wheel) for (var s = this.options.wheel.rotate, o = void 0 === s ? 25 : s, n = 0; n < this.items.length; n++) {
    ...
    this.isAnimating = !0, H(this.animateTimer), function t() {
      ...
      var e = l(i = (i - f) / a),
          ...
          o = (h - d) * e + d,
          n = (m - u) * e + u;
      c._translate(s, o, n), c.isAnimating && (c.animateTimer = z(t)), c.options.probeType === R && c.trigger("scroll", {
        x: c.x,
        y: c.y
      });
    }();
    ...
    var e = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : 0,
        s = 3 < arguments.length && void 0 !== arguments[3] ? arguments[3] : D.bounce;
    this.isInTransition = this.options.useTransition && 0 < e && (t !== this.x || i !== this.y), !e || this.options.useTransition ? (this._transitionTimingFunction(s.style), this._transitionTime(e), this._translate(t, i), e && this.options.probeType === R && this._startProbe(), e || t === this.x && i === this.y || (this.trigger("scroll", {
      x: t,
      y: i
    ...
    var t = window.getComputedStyle(this.scroller, null),
        i = void 0,
        e = void 0;
    return this.options.useTransform ? (i = +((t = t[T.transform].split(")")[0].split(", "))[12] || t[4]), e = +(t[13] || t[5])) : (i = +t.left.replace(/[^-\d.]/g, ""), e = +t.top.replace(/[^-\d.]/g, "")), {
      x: i,
      y: e
    };
  ...
  }, (Z = ot).prototype.on = function (t, i) {
    ...
    if (i) for (var e = i.length, s = [].concat(c(i)), o = 0; o < e; o++) {
      var n = s[o],
          r = l(n, 2),
          h = r[0],
          a = r[1];
    ...
    "string" == typeof g && (g = this.scroller.querySelectorAll(g)), this.on("refresh", function () {
      if (m.pages = [], m.wrapperWidth && m.wrapperHeight && m.scrollerWidth && m.scrollerHeight) {
        var t = f.stepX || m.wrapperWidth,
            ...
            l = void 0,
            c = void 0;
        if (g) for (h = g.length, l = -1; r < h; r++) {
          c = Y(g[r]), (0 === r || c.left <= Y(g[r - 1]).left) && (a = 0, l++), m.pages[a] || (m.pages[a] = []), e = Math.max(-c.left, m.maxScrollX), s = Math.max(-c.top, m.maxScrollY), o = e - Math.round(c.width / 2), n = s - Math.round(c.height / 2), m.pages[a][l] = {
            x: e,
            y: s,
            width: c.width,
            height: c.height,
        ...
        } else for (o = Math.round(t / 2), n = Math.round(i / 2); e > -m.scrollerWidth;) {
          for (m.pages[r] = [], s = h = 0; s > -m.scrollerHeight;) {
            m.pages[r][h] = {
  ...
  }, j.prototype.getCurrentPage = function () {
    var t = this.options.snap;
  ...
  }, (G = ot).prototype.wheelTo = function () {
    var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : 0;
    this.options.wheel && (this.y = -t * this.itemHeight, this.scrollTo(0, this.y));
  }, G.prototype.getSelectedIndex = function () {
    return this.options.wheel && this.selectedIndex;
  }, G.prototype._initWheel = function () {
    ...
    this.options.scrollX && (r = {
      ...
      fade: s,
      interactive: n
    }, this._insertScrollBar(r.el), this.indicators.push(new B(this, r))), this.options.scrollY && (r = {
      el: N("vertical"),
      direction: "vertical",
      fade: s,
      interactive: n
    }, this._insertScrollBar(r.el), this.indicators.push(new B(this, r))), this.on("refresh", function () {
      for (var t = 0; t < i.indicators.length; t++) {
        i.indicators[t].refresh();
      }
      ...
      for (var t = 0; t < i.indicators.length; t++) {
        i.indicators[t].fade(!0);
      }
    }), this.on("beforeScrollStart", function () {
      for (var t = 0; t < i.indicators.length; t++) {
        i.indicators[t].fade(!0, !0);
      }
    })), this.on("destroy", function () {
      i._removeScrollBars();
    });
  }, $.prototype._insertScrollBar = function (t) {
    this.wrapper.appendChild(t);
  }, $.prototype._removeScrollBars = function () {
    for (var t = 0; t < this.indicators.length; t++) {
      this.indicators[t].destroy();
    }
  }, (J = ot).prototype._initPullDown = function () {
    this.options.probeType = R;
  }, J.prototype._checkPullDown = function () {
  ...
  }, J.prototype.finishPullDown = function () {
    this.pulling = !1, this.resetPosition(this.options.bounceTime, D.bounce);
  }, J.prototype.openPullDown = function () {
    var t = !(0 < arguments.length && void 0 !== arguments[0]) || arguments[0];
    this.options.pullDownRefresh = t, this._initPullDown();
  }, J.prototype.closePullDown = function () {
    this.options.pullDownRefresh = !1;
  }, (K = ot).prototype._initPullUp = function () {
    this.options.probeType = R, this.pullupWatching = !1, this._watchPullUp();
  }, K.prototype._watchPullUp = function () {
    this.pullupWatching || (this.pullupWatching = !0, this.on("scroll", this._checkToEnd));
  }, K.prototype._checkToEnd = function (t) {
    var i = this,
        e = this.options.pullUpLoad.threshold,
        s = void 0 === e ? 0 : e;
    this.movingDirectionY === W && t.y <= this.maxScrollY + s && (this.once("scrollEnd", function () {
      i.pullupWatching = !1;
  ...
  }, (Q = ot).prototype._initMouseWheel = function () {
    var t = this;
    this._handleMouseWheelEvent(h), this.on("destroy", function () {
      clearTimeout(t.mouseWheelTimer), clearTimeout(t.mouseWheelEndTimer), t._handleMouseWheelEvent(u);
    }), this.firstWheelOpreation = !0;
  }, Q.prototype._handleMouseWheelEvent = function (t) {
    ...
    if (this.enabled) {
      ...
      var m = this.y === u;
      this.scrollTo(d, u, a, D.swipe), this.trigger("scroll", {
        x: this.x,
        y: this.y
  ...
  }, ot.prototype._initInfinite = function () {
    this.options.probeType = 3, this.maxScrollY = -it, this.infiniteScroller = new st(this, this.options.infinity);
  }, ot.Version = "1.12.6", ot;
});