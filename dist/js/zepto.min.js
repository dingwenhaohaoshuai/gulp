  ...
  var e = function () {
    ...
    return N.matches = function (t, e) {
      ...
      find: function find(t) {
        var e,
            n = this;
        return e = t ? "object" == _typeof(t) ? r(t).filter(function () {
          var t = this;
  ...
  return t.Zepto = e, void 0 === t.$ && (t.$ = e), function (e) {
    ...
    function y(t, n, i, o, s, u, f) {
      ...
      n.split(/\s/).forEach(function (n) {
        ...
        var a = d(n);
        a.fn = i, a.sel = s, a.e in l && (i = function i(t) {
    ...
    h.href = t.location.href, e.active = 0, e.ajaxJSONP = function (i, o) {
      ...
      if (N.open(s.type, s.url, A, s.username, s.password), s.xhrFields) for (o in s.xhrFields) {
        N[o] = s.xhrFields[o];
      }
...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    $(document).bind('MSGestureEnd', function (e) {
      ...
      touch.y2 = firstTouch.pageY; //console.log( touch )
